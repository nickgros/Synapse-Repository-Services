...
public class ArrayNode implements Node {
	...
	private Long length; // the length of the array, including deleted elements.
	...
	public ArrayNode setLength(Long length) {
		this.length = length;
		return this;
	}
	...
	@Override
	public int hashCode() {
		return Objects.hash(nodeId, elements, length);
	}
	...
	public String toString() {
		return "ArrayNode [nodeId=" + nodeId + ", elements=" + elements + ", length=" + length + "]";
	}
