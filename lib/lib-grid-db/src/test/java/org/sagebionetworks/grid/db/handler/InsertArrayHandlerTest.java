...
public class InsertArrayHandlerTest {
	...
	public void testExpandInsertArrays() {
		...
		List<RGANode> expected = List.of(
				//
				new RGANode().setDataId(new LogicalTimestamp().setReplicaId(99L).setSequenceNumber(1L))
						.setNodeId(ids.get(0)).setDataId(ids.get(1)).setRefId(ids.get(0)),
				//
				new RGANode().setDataId(new LogicalTimestamp().setReplicaId(99L).setSequenceNumber(2L))
						.setNodeId(ids.get(0)).setDataId(ids.get(2))
						.setRefId(new LogicalTimestamp().setReplicaId(99L).setSequenceNumber(1L)),
				//
				new RGANode().setDataId(new LogicalTimestamp().setReplicaId(101L).setSequenceNumber(1L))
						.setNodeId(ids.get(3)).setDataId(ids.get(5)).setRefId(ids.get(4)),
				//
				new RGANode().setDataId(new LogicalTimestamp().setReplicaId(101L).setSequenceNumber(2L))
						.setNodeId(ids.get(3)).setDataId(ids.get(6))
						.setRefId(new LogicalTimestamp().setReplicaId(101L).setSequenceNumber(1L))
	...
	public void testHandleBatch() {
		RGANode one = new RGANode().setDataId(ids.get(0));
		RGANode two = new RGANode().setDataId(ids.get(1));
		...
		assertEquals(ids.get(2), two.getRefId());
